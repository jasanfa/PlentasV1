...
export class OutputComponent implements OnInit {
  ...
  updateTable(){
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_1 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_1 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    } 
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_2 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_2 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_3 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_3 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    }
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_4 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_4 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    }
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_5 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_5 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    }
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_6 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_6 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    }
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_7 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_7 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    }
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_8 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_8 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    }
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_9 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"] *10).toFixed(2)) + " / 10";
      this.bert_9 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    }
    ...
    if (indx >= this.numberStudents) {
      ...
      this.spacy_10 = JSON.stringify((Plentas[indx.toString()]["NotaSpacy"]*10).toFixed(2)) + " / 10";
      this.bert_10 = JSON.stringify((Plentas[indx.toString()]["NotaBert"]*10).toFixed(2)) + " / 10";
    }
