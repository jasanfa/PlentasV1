...
from OldApi.utils.Semantics.utils import save_json, load_json
...
path_created_dataset = "OldApi/Jacobo/Prueba3/JoinedSubjects2.json"
...
class SentTransf_train():
    def __init__(self, modelsToTrain = [
              ...
              ], epochsToTest = [1,5,10,30,50,100], saving_path = 'OldApi/Jacobo/Prueba3/'):
...
class SentTransf_test():
    def __init__(self, modelsToTest = ['distiluse-base-multilingual-cased-v1'
              ...
              ], epochsToTest = [1,5,10,30,50,100], save_path = 'OldApi/Jacobo/Prueba3'):
